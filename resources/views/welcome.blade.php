...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <!-- Football Score System Section -->
            <div class="mt-16">
                <div class="text-center mb-12">
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">⚽ Football Score System</h1>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-8">Real-time football match tracking with
                        WebSocket technology</p>
